...
<div id="comments" class="comments-area">
  ...
  if (have_comments()) : ?>
    ...
    <ul class="comment-list">
      <?php
      wp_list_comments(array('callback' => 'bootscore_comment', 'avatar_size' => 60));
      ?>
    </ul><!-- .comment-list -->
  ...
  <?php comment_form($args = array(
    ...
    'label_submit'      => __('', 'bootscore'),  // that's the wordpress default value! delete it or edit it ;)

    'comment_field' => '<input placeholder="' . __('اكتب تعليقك', 'bootscore') . '" id="comment" class="form-control" name="comment" aria-required="true"/>',
